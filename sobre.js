...
function addToCart(button) {
  ...
  // Usa o atributo data-preco para obter o preço corretamente
  const price = parseFloat(produto.getAttribute('data-preco'));
  ...
  try {
    ...
    produtos.forEach(produto => {
      ...
      if (categorySection) {
        ...
        `;
        // Define o atributo data-preco para garantir a formatação correta
        productElement.setAttribute('data-preco', produto.preco.toFixed(2));
